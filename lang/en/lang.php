...
return [
    ...
    'settings' => [
        ...
        'adopt_translated_names' => 'Adopt translated names',
        'adopt_translated_names_comment' => 'When an English name is not given, the first translation will be used',
        ...
        'server_email_verified' => 'Server email capability verified',
        'server_email_verified_not' => 'Server email capability not verified. <a href="/backend/system/settings/update/acorn/user/settings#primarytab-acornuserlangsettingsregistration-tab" target="_blank">Verify</a>',
        'server_email_verified_comment' => 'Registration fields concerning email sending will be disabled if server capability is not verified',
